      ...
      <div className="flex-1 overflow-y-auto p-4 pb-[calc(2.5rem+env(safe-area-inset-bottom,0px))] bg-[#050B18]">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          {menuItems.map((item) => (
            <div
              key={item.id}
              className="bg-[#0F172A] border border-[#1E293B] rounded-2xl p-4 shadow-sm flex flex-col gap-3 cursor-pointer hover:bg-[#141E33] hover:border-[#1877F2]/40 transition-all group"
              onClick={() => handleMenuItemClick(item)}
            >
              <div className="w-10 h-10 rounded-xl bg-[#0B1120] border border-[#1E293B] flex items-center justify-center group-hover:scale-105 transition-transform">
        ...
        <div className="flex flex-col gap-1.5 mb-8">
          {bottomItems.map((item) => (
            <div
              key={item.id}
              className="flex items-center justify-between p-3 rounded-xl bg-[#0F172A]/50 border border-[#1E293B]/60 hover:bg-[#141E33] hover:border-[#1E293B] cursor-pointer transition-colors"
              onClick={() => handleMenuItemClick(item)}
            >
          ...
          <div
            className="flex items-center justify-between p-3 rounded-xl bg-[#0F172A]/50 border border-[#1E293B]/60 hover:bg-[#EF4444]/10 hover:border-[#EF4444]/40 cursor-pointer transition-colors mt-2 text-[#F87171]"
            onClick={onLogout}
          >
            <div className="flex items-center gap-3">
  ...
  return (
    <>
      ...
      {currentUser && showProfileMenu && (
        <div
          ref={profileRef}
          className="fixed top-[58px] right-3 w-[290px] bg-[#0F172A] rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.65)] border border-[#1E293B] z-[190] p-2 overflow-hidden animate-fade-in"
        >
          <div
            className="flex items-center gap-3 p-2.5 hover:bg-[#141E33] rounded-xl cursor-pointer transition-colors mb-1.5"
            onClick={() => {
          ...
          <div
            className="flex items-center gap-3 p-2.5 hover:bg-[#EF4444]/10 rounded-xl cursor-pointer text-[#F87171] transition-colors"
            onClick={() => {
              setShowProfileMenu(false);
              onLogout();
            }}
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className="w-[300px] h-full overflow-y-auto px-2 pt-4 pb-24 bg-[#050B18] hidden lg:block scrollbar-hide border-r border-[#1E293B]">
      <div
        className="flex items-center gap-3 p-2.5 hover:bg-[#0F172A] border border-transparent hover:border-[#1E293B] rounded-xl cursor-pointer transition-colors mb-2"
      ...
      {items.map((item) => (
        <div
          key={item.id}
          className="flex items-center gap-3 p-2.5 hover:bg-[#0F172A] border border-transparent hover:border-[#1E293B] rounded-xl cursor-pointer mb-1 transition-colors"
          onClick={item.onClick}
        >
          <div className="w-8 h-8 rounded-lg bg-[#0B1120] border border-[#1E293B] flex items-center justify-center">
...
export const RightSidebar: React.FC<{
  ...
  return (
    <div className="w-[280px] h-full overflow-y-auto pt-4 pr-2 pb-24 bg-[#050B18] hidden xl:block scrollbar-hide border-l border-[#1E293B]">
